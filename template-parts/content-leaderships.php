...
<!-- </div> -->
    <?php endif;
			...
			the_title( '<h2 class="entry-title physician-name" style="padding: 0;"><a href="' . esc_url( get_permalink() ) . '" rel="bookmark">', '</a></h2>' );



      ?>
<h5 style="margin: 0;"><?php echo the_field('profession'); ?></h5>
