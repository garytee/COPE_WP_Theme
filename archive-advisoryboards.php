...
<div class="page-title">COPE Scientific Advisory Board</div>
...
?>
  ...
  <?php if ( get_edit_post_link() ) : ?>
    <footer class="entry-footer">
      ...
      <span class="no-smoothstate edit-link animated fadeInUp"><a href="/wp-admin/edit.php?post_type=advisoryboards">Edit Advisory Board</a></span>
    </footer><!-- .entry-footer -->
  <?php endif; ?>
