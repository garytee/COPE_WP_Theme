...
<div class="page-title">COPE Leadership</div>

	<div id="primary" class="content-area leadership-archive">
		...
		if ( have_posts() ) : ?>
			...
			while ( have_posts() ) : the_post();
				...
				// get_template_part( 'template-parts/content', 'advisoryboards', get_post_format() );
				get_template_part( 'template-parts/content', 'leaderships', get_post_format() );
...
?>
  ...
  <?php if ( get_edit_post_link() ) : ?>
    <footer class="entry-footer">
      ...
      <span class="no-smoothstate edit-link animated fadeInUp"><a href="/wp-admin/edit.php?post_type=leaderships">Edit Leadership</a></span>
    </footer><!-- .entry-footer -->
  <?php endif; ?>
