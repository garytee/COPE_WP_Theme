...
;(function ($, window, document, undefined) {
	...
	var url = storelocatorjs.template_url;
	...
	var defaults = {
		...
		'distanceAlert'              : 60,
		'dataType'                   : 'json',
		'dataLocation'               : url+'/data/locations.json',
		'dataRaw'                    : null,
		'xmlElement'                 : 'marker',
		'listColor1'                 : '#ffffff',
		'listColor2'                 : '#eeeeee',
		...
		'dragSearch'                 : false,
		'infowindowTemplatePath'     : url+'/assets/js/plugins/storeLocator/templates/infowindow-description.html',
		'listTemplatePath'           : url+'/assets/js/plugins/storeLocator/templates/location-list-description.html',
		'KMLinfowindowTemplatePath'  : url+'/assets/js/plugins/storeLocator/templates/kml-infowindow-description.html',
		'KMLlistTemplatePath'        : url+'/assets/js/plugins/storeLocator/templates/kml-location-list-description.html',
		'listTemplateID'             : null,
